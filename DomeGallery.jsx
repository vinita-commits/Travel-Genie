...
import udaipur from './pics/udaipur.jpg';
import homeBG from './pics/homeBG.jpeg';
import jaipur from './pics/jaipur.jpg';
import Card1 from './pics/card1.jpg';
import Card2 from './pics/card2.jpg';
import Goa from './pics/Goa.jpg';
import bg from './pics/homeBG.jpeg';
  ...
  return (
    ...
    >
      <main ref={mainRef} className="sphere-main">
        <h1 className="sphere-title">Travel Genie</h1>
        <p className="sphere-tagline">Trips that feel like magic</p>
        <div className="stage">
